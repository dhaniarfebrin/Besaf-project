                ...
                <div class="col-md-4 mt-3">
                    <div class="card bg-dark shadow">
                        ...
                        <div class="card-image" align="center">
                            <img src="" alt="" class="mw-100 img-fluid image p-3">
                        </div>
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <p class="text-sm registrasi">Until Sunday, 1 Des 1999 - 2:00 pm, GMT +7</p>
                            </div>
                            <div>
                                <h5 class="text-secondary text-md">Tournament Start</h5>
                                <p class="text-sm date">Begin on Fri, 7 Feb 2020 - 3:00 pm, GMT +7</p>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters">
                                ...
                                <div class="col text-sm">
                                    <p class="hover komunitas_nama">Yamisok</p>
        ...
        <div class="modal fade" id="how_to_join" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body how_to_join">
                    ...
                    <div class="modal-body">
                        <table class="table table-borderless text-white">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="hadiah1">1.000.000</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td class="hadiah2">2.000.000</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td class="hadiah3">3.000.000</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
