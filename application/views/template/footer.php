	...
	<div class="m-quick-sidebar__content m--hide">
		...
		<ul id="m_quick_sidebar_tabs" class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand" role="tablist">
			<li class="nav-item m-tabs__item">
				<a class="nav-link m-tabs__link active" data-toggle="tab" href="<?= base_url(''); ?>#m_quick_sidebar_tabs_messenger" role="tab">Messages</a>
			</li>
			<li class="nav-item m-tabs__item">
				<a class="nav-link m-tabs__link" data-toggle="tab" href="<?= base_url(''); ?>#m_quick_sidebar_tabs_settings" role="tab">Settings</a>
			</li>
			<li class="nav-item m-tabs__item">
				<a class="nav-link m-tabs__link" data-toggle="tab" href="<?= base_url(''); ?>#m_quick_sidebar_tabs_logs" role="tab">Logs</a>
			</li>
		</ul>
				...
				<div class="m-messenger m-messenger--message-arrow m-messenger--skin-light">
					...
					<div class="m-messenger__form">
						...
						<div class="m-messenger__form-tools">
							<a href="<?= base_url(''); ?>" class="m-messenger__form-attachment">
				...
				<div class="m-list-timeline m-scrollable">
					<div class="m-list-timeline__group">
						...
						<div class="m-list-timeline__items">
							<div class="m-list-timeline__item">
								...
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">12 new users registered
							...
							<div class="m-list-timeline__item">
								...
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">System shutdown</a>
								<span class="m-list-timeline__time">11 mins</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-danger"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">New invoice received</a>
								<span class="m-list-timeline__time">20 mins</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-warning"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">Database overloaded 89%
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">System error</a>
								<span class="m-list-timeline__time">2 hrs</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">Production server down
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">Production server up</a>
					...
					<div class="m-list-timeline__group">
						...
						<div class="m-list-timeline__items">
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">New order received
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">12 new users registered</a>
								<span class="m-list-timeline__time">Just now</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-danger"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">New invoices received</a>
								<span class="m-list-timeline__time">20 mins</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-warning"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">Database overloaded 89%</a>
								<span class="m-list-timeline__time">1 hr</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">System error
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">Production server down</a>
								<span class="m-list-timeline__time">3 hrs</span>
							</div>
						</div>
					</div>
					<div class="m-list-timeline__group">
						...
						<div class="m-list-timeline__items">
							...
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-info"></span>
								<a href="<?= base_url(''); ?>" class="m-list-timeline__text">New order received</a>
								<span class="m-list-timeline__time">7 hrs</span>
							</div>
							<div class="m-list-timeline__item">
								<span class="m-list-timeline__badge m-list-timeline__badge--state-success"></span>
...
<!-- <ul class="m-nav-sticky">
			<li class="m-nav-sticky__item" data-toggle="m-tooltip" title="Chat" data-placement="left">
				<a href="#" class="toggle-chat fa fa-comment text-dark">
				</a>
			</li>
		</ul>
		...
		<div class="chat card shadow-lg">
			...
			<div class="card-body">
				<div class="m-scrollable m-scrollable--track" data-scrollable="true" style="height: 320px">
					asdlhasjhdbr	\\<br>
					aefas,jdgkhgjh
					asdlhasjhdbr	\\<br>
					aefas,jdgkhgjh
